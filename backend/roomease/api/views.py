...
from .views_dir import register_view,group_view,group_invite_view,group_member_view,expense_view,settlement_view
...
SettlementView = settlement_view.SettlementView